...
function Contact() {
  const { register, handleSubmit, formState: { errors } } = useForm(); // Moved useForm inside the component
  ...
  const onSubmit =async(data) =>  {
    ...
    try{
     await axios.post("https://getform.io/f/bmdddmpa",userInfo);
      ...
      <div name="Contacts" className="max-w-screen-2xl container mx-auto px-4 md:px-20 my-16">
        ...
        <div className="flex flex-col items-center justify-center mt-5">
          <form
            ...
            // action="https://getform.io/f/bmdddmpa"
            // method="POST"
          ...
          >
            ...
            <div className="flex flex-col mb-4">
              <label className="block text-gray-700">Messages</label>
              <textarea
